  ...
  <section class="top-service">
    <div class="l-container">
      ...
      <div class="top-service__inner" data-inview>
        <p class="m-top-section__copy">自動化技術で、<br>世界中のものづくりに流れを。</p>
        <p class="u-m">お客様の「ものづくり」をよりスマートにするために、私たち技研は「自動化」をテーマに、安心して使い続けることのできる製品を生み出しています。自動車事業・アルミ事業・産業機械事業を中心に、常にお客様のことを第一に考え、より最適なソリューションを提案し続けます。</p>
  ...
  <section class="top-company">
    <div class="l-container__large">
      ...
      <div class="top-company__inner" data-inview>
        ...
        <p class="u-m">石川県能美市を本社に、グローバルな世界展開を行なっております。国内外のさまざまな「ものづくり」に効率化、省力化、無人化を生み出し、社会に貢献します。</p>
    ...
    <div class="top-information__outer">
      <div class="top-information__recruit">
        ...
        <div class="top-information__inner">
          ...
          <p class="u-m">技研では、共に技術で世界の流れをつくるスタッフを募集しています。新卒/中途は問いません、まずは私たちのことを知ってください。</p>
      ...
      <div class="top-information__csr">
        ...
        <div class="top-information__inner">
          ...
          <p class="u-m">社会をより豊かにすることを目的に、社会貢献活動にも力を入れていきます。また、クリーンエネルギーによる環境への配慮も行なっています。</p>
