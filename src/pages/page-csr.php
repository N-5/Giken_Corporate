...
<main id="csr">
  ...
  <section class="csr-society">
    <div class="l-container">
      <h2 class="m-section-title">FOR SOCIETY<span>社会貢献活動について</span></h2>
    </div>
    <div class="l-container__small">
      <div class="csr-list">
        <div class="csr-list__item">
          <h3 class="csr-heading">エコキャップ活動</h3>
          <div class="csr-list__inner">
            <div class="csr-list__image"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/csr/csr-society_1.jpg" alt=""></div>
            <div class="csr-list__detail">
              <p class="csr-list__text">
                当社ではエコキャップ回収運動を行っています。 ペットボトルのキャップで世界の子供にワクチンを届けることができます。普段捨ててしまうキャップでも、約2キロ程度（約860個）でポリオワクチン１人分相当の20円になり、子どもの命が救えます。
              </p>
              <div class="csr-list__link"><a href="<?php echo get_stylesheet_directory_uri(); ?>/pdf/" target="_blank"><i>PDF</i><span>2017/01/ 活動報告</span></a></div>
            </div>
          </div>
        </div>
  ...
  <section class="csr-environment">
    <div class="l-container">
      <h2 class="m-section-title">FOR ENVIRONMENT<span>環境への取り組み</span></h2>
    </div>
    <div class="l-container__small">
      <div class="csr-list">
        <div class="csr-list__item">
