...
<main id="recruit">
  ...
  <section class="recruit-philosophy">
    <div class="l-container">
      ...
      <h3 class="recruit-philosophy__concept">
        一歩先んじた技術で社会に貢献し、<br>
        調和のとれた発展で、<br>
        社員の生活をより豊かにする。
      </h3>
      <p class="recruit-philosophy__text">この経営理念に沿い、お客様、地域社会の方々、従業員等、弊社を取り巻く皆様の期待に応えるべく活動を行っています。社会への貢献や社会的責任を果たせる企業でありたいと考えております。</p>
    </div>
  ...
  <section class="recruit-person">
    <div class="l-container">
      <h2 class="m-section-title">TYPE OF PERSON<span>求める人材像</span></h2>
      <ul class="recruit-person__items">
        <li class="item-list">
          <div class="heading"><span class="heading__number">01</span><span class="heading__t">健康</span></div>
          <div class="text">いかなる時も心身ともに社会人として自分のパフォーマンスを最大化する環境づくりができる人</div>
        </li>
        <li class="item-list">
          <div class="heading"><span class="heading__number">02</span><span class="heading__t">素直</span></div>
          <div class="text">相手を問わず自分の意見がしっかりと伝えられる人</div>
        </li>
        <li class="item-list">
          <div class="heading"><span class="heading__number">03</span><span class="heading__t">調和</span></div>
          <div class="text">価値観が違う人の意見に耳を傾け、相手の考えを理解することができる人</div>
        </li>
      </ul>
    </div>
  </section>
  ...
  <section class="recruit-support">
    <div class="recruit-support__inner">
      <div class="recruit-support__top">
        ...
        <div class="recruit-support__top-detail">
          ...
          <div class="text">
            <p>技研では、各分野に精通したプロフェッショナルな人材を育成するために、職場でのOJT<small>※</small>をベースとした教育体系を整えています。専門的な知識をじっくりと時間をかけて習得・経験するとともに、急激な世界経済の変化が続く現代でも、主体性・チームワーク・適応性が発揮できるよう、どの社員も新たなチャレンジやワールドワイドな体験を通じて、大きく成長していきます。<br>また、OJTを補完する手段として業務知識、マネジメント知識に加え、グローバル化（語学）や自己啓発を含めた各種資格の取得費用をサポート（業務に資すると会社が認めた資格の全額費用を補助）しています。</p>
            <p>※ OJT (On the Job Training)　日常の職場の中で日常的な業務を遂行しながら、仕事に必要な知識・技能・技術・態度を計画的にレベルアップしていくこと。</p>
          </div>
        </div>
      </div>
      <div class="recruit-support__under l-container">
