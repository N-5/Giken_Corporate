  ...
  <section class="page-navigation">
    <div class="l-container">
      <div class="page-navigation-list news-navigation">
        ...
        <div class="page-navigation-list__item <?php if ( is_object_in_term($post->ID, 'news-category','event') ): ?>is-active<?php endif; ?>"><a href="<?php echo home_url(); ?>/news-category/event/"><span>EVENT</span></a></div>
        <div class="page-navigation-list__item <?php if ( is_object_in_term($post->ID, 'news-category','topics') ): ?>is-active<?php endif; ?>"><a href="<?php echo home_url(); ?>/news-category/topics/"><span>NEWS</span></a></div>
        <div class="page-navigation-list__item <?php if ( is_object_in_term($post->ID, 'news-category','recruit') ): ?>is-active<?php endif; ?>"><a href="<?php echo home_url(); ?>/news-category/recruit/"><span>RECRUIT</span></a></div>
      </div>
    </div>
  </section>
